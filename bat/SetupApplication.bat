...
:: Android packaging
set AND_CERT_NAME="My-Very-Own-Lith-AIR"
set AND_CERT_PASS=testpassword
set AND_CERT_FILE=cert\MVOLAIR.p12
...
set IOS_PROVISION=cert\MyVeryOwnLithAIR.mobileprovision
...
::set APP_ID=org.com.lithier.MyVeryOwnLithPlus
set APP_ID=org.com.lithier.MyVeryOwnLith

:: Output packages
set DIST_PATH=dist
set DIST_NAME=MyVeryOwnLithAIR

:: Debugging using a custom IP
set DEBUG_IP=192.168.1.104
